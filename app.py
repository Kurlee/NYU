...
question_prompts = [
    ...
    "Question 57:\nThe transfer of an HTML file from one host to another host is:\n\n\n(a) Loss-tolerant and time sensitive\n(b) Loss-intolerant and time sensitive\n(c) Loss-intolerant and time insensitive\n(d) Non of the above\n\nYour Answer:__",
    "Question 58:\nA browser will generate header lines as a function of:\n\n\n(a) Whether the browser has a chached version of the requested object\n(b) Browser type and version\n(c) User configuration of browser\n(d) All of the above\n\nYour Answer:__",
    "Question 59:\nSuppose a client sends an HTTP request message with the \"If-modified-since:\" header.\nSuppose the object in a server has not changed since the last time a client retrieved the object.\nThen the server will send a response message withthe status code:\n\n\n(a) 404 Not Found\n(b) 200 OK\n(c) 304 Not Modified\n(d) 757 All Hello\n\nYour Answer:__",
    ...
    "Question 61:\nSuppose a DNS resource record has Type=MX. Then___\n\n\n(a) Value is the hostname of the mail server that has the alias hostname Name.\n(b) Value is the IP address of the mail server that has the alias hostname Name.\n(c) Value is the hostname of the DNS server that is authoritative for Name\n(d) None of the above\n\nYour Answer:__", 
    "Question 62:\nBased on Section 2.2.5 Web Caching, Page 113, Answer the following question:\n\n\nSuppose the hit rate is .5 (instead of .4) in the caching example in the text.\nThen the average delay is\n\n\n(a) Greater than 2 seconds\n(b) Between 1.0 and 1.1 seconds\n(c) Between 1.2 and 1.3 seconds\n(d) None of the above\n\nYour Answer:__",
    ...
    "Question 65:\nFor BitTorrent, which of the following is true:\n\n\n(a) Among the chunks that a peer does not have,\nthe peer will request chunks that appear to be relatively rare in the torrent\n(b) At a given instant of time, a peer A may upload to a peer B,\neven if peer B is not sending anything to A\n(c) Although a peer may have 50 concurrent TCP connections with other peers,\nat any given instant of time it sends data to less than 10 other peers.\n(d) All of the above\n\nYour Answer:__",
    ...
    "Question 69:\nIf a POP3 client does not send the \"dele\" command,\ncopies of the messages that the client has retrieved remain in the mail server.\n\n\n(a) True\n(b) False\n\nYour Answer:__",
    ...
    "Question 72:\nWith non-persistent connections between browser and origin server,\nit is possible for a single TCP segment to carry two distinct HTTP request messages.\n\n\n(a) True\n(b) False\n\nYour Answer:__",
    "Question 73:\nThe \"Date:\" header in the HTTP response message indicates when the object in the\nresponse was last modified.\n\n\n(a) True\n(b) False\n\nYour Answer:__",
...
questions = [
    ...
    Question(question_prompts[65], "b"),
    Question(question_prompts[66], "b"),
    Question(question_prompts[67], "a"),
    Question(question_prompts[68], "a"),
    Question(question_prompts[69], "a"),
    Question(question_prompts[70], "a"),
    Question(question_prompts[71], "b"),
    Question(question_prompts[72], "b"),
    Question(question_prompts[73], "b"),
    Question(question_prompts[74], "a"),
    # Question(question_prompts[75], ""),
    # Question(question_prompts[76], ""),
    # Question(question_prompts[77], ""),
